...
- [Einrichtung](#einrichtung)
  ...
  - [2. Server eintragen](#2-server-eintragen)
  - [3. Discord-Webhook eintragen](#3-discord-webhook-eintragen-optional)
  - [4. Stack starten](#4-stack-starten)
- [Setup-Script](#setup-script)
- [Deployment-Modi](#deployment-modi)
  - [Modus 1 — Core](#modus-1--core-prometheus--grafana)
  - [Modus 2 — Core + Caddy](#modus-2--core--caddy-httphttps-reverse-proxy)
  - [Modus 3 — Core + Caddy + Homepage](#modus-3--core--caddy--homepage)
  - [Homepage — Server-Karten](#homepage--server-karten)
  - [Homepage — Anzeigenamen konfigurieren](#homepage--anzeigenamen-konfigurieren)
- [Minecraft-Server einrichten](#minecraft-server-einrichten)
  - [1. Plugin installieren](#1-plugin-installieren)
  - [2. Plugin konfigurieren](#2-plugin-konfigurieren)
  - [3. Firewall](#3-firewall)
- [Weiteren Server hinzufügen](#weiteren-server-hinzufügen)
  - [Szenario 1 — Externer Server](#szenario-1--externer-server-internet)
  - [Szenario 2 — Lokaler Server im selben Docker-Netzwerk](#szenario-2--lokaler-server-im-selben-docker-netzwerk)
  - [Szenario 3 — Lokaler Server, Port nach außen gemappt](#szenario-3--lokaler-server-port-nach-außen-gemappt)
